...
<body>
        ...
        <div id="visual">
            <div class="slide-visual">
                <ul class="slide-group">
                    <li><img class="img-responsive" src="images/bg1.jpg"alt="image" /></li>
                    <li><img class="img-responsive" src="images/bg1.jpg" alt="image" /></li>
                    <li><img class="img-responsive" src="images/bg1.jpg" alt="image" /></li>
                </ul>
    <!--            <div class="script-wrap">
                   ...
                   <li><div class="inner-script">
                                <img class="img-responsive" src="images/background.jpeg" alt="Image" />
                            </div></li>
                        <li><div class="inner-script">
